...
const Signup = () => {
  ...
  const handleGoogleLogin = async (idToken: string) => {
    try {
      ...
      await AsyncStorage.setItem("needsGreeting", "true");
      router.replace("/(tabs)");
    } catch (err: any) {
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (!GOOGLE_IS_CONFIGURED) {
                      showToast("Google Not Configured", "error");
                      return;
                    }
                    signIn();
                  }}
...
const styles = StyleSheet.create({
  ...
  inputWrapper: { marginBottom: scale(18) },
  inputLabel: {
    fontSize: rf(14),
    fontWeight: "700",
    color: "#4A235A",
  ...
  footerLink: { marginTop: scale(35), alignItems: "center", marginBottom: scale(20) },
